...
export const TRANSFORMATIONS: readonly Transformation[] = [
  {
    ...
    startKg: 94,
    endKg: 78,
    beforeSrc: "/transformations/t3-before.jpg",
    afterSrc: "/transformations/t3-after.jpg",
    testimonial:
  ...
  },
  {
    ...
    startKg: 76,
    endKg: 61,
    beforeSrc: "/transformations/t2-before.jpg",
    afterSrc: "/transformations/t2-after.jpg",
    testimonial:
  ...
  },
  {
    ...
    startKg: 58,
    endKg: 68,
    beforeSrc: "/transformations/t4-before.jpg",
    afterSrc: "/transformations/t4-after.jpg",
    testimonial:
      "Gained 10 kg without junk. The non-veg days were scheduled around my hostel mess menu.",
  },
  {
    slug: "meera",
    displayName: "Garvit J.",
    goalLabel: "Fat loss",
    weeks: 12,
    startKg: 85,
    endKg: 72,
    beforeSrc: "/transformations/t1-before.jpg",
    afterSrc: "/transformations/t1-after.jpg",
    testimonial:
